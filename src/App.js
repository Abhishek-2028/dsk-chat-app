...
function App() {
  ...
  return (
    <>
      ...
      <Paper sx={{ bgcolor: '#1F1B24', width:{xl:'35vw',xs:'auto'}, mx: {xl:'25%'}, height: {xl:'98vh',xs:'auto'}, my: {xl:1,xs:0}, borderRadius: '14px' }} elevation={7} >
          ...
          name ?
            <>
              <ScrollToBottom initialScrollBehavior='smooth'>
                <Box component='div' sx={{ width: 580, height: 715 }} >
