  ...
  return (
    <>
      ...
      <Paper sx={{ bgcolor: '#1F1B24', width:{xl:'35vw',xs:'auto'}, mx: {xl:'25%'}, height: {xl:'98vh',xs:'auto'}, my: {xl:1,xs:0}, borderRadius: {xl:'14px',xs:'0px'} }} elevation={7} >
        ...
        <Box component='div' sx={{ display:{xl:'block',xs:'none'},bgcolor: '#6200EE', height: 0.08, mt: 0, width: 'inherit', fontFamily: 'fantasy', borderRadius: { xl:'14px 14px 0px 0px',xs:'0px 0px 0px 0px'}  }}>
          ...
          name ?
            <>
              <ScrollToBottom initialScrollBehavior='smooth'>
                <Box component='div' sx={{ width: 580, height:{xl:715,xs:'auto'} }} >
